...
PAGE_COLUMNS = [
    ...
    "reserved_slot_category",
    "selected_under_reserved_slot",
    "crawl_selection_reason",
    "crawl_budget_position",
    "matched_priority_segment",
    "priority_match_type",
    "priority_rule_id",
    "priority_match_confidence",
    "path_language_hint",
    "path_language_priority",
    "language_path_reason",
    "page_category",
    ...
    "detected_language",
    "language_confidence",
    "language_hint_detection_agreement",
...
OBSERVATION_TEXT_SUMMARY_COLUMNS = [
    ...
    "n_unique_branding_pages",
    "n_impressum_pages",
    "n_legal_technical_pages",
    "n_duplicate_pages",
    "n_duplicate_pages_within_observation",
    "duplicate_tokens_removed",
    "duplicate_words_removed",
...
CRAWL_PRIORITY_SUMMARY_COLUMNS = [
    ...
    "relative_timepoint",
    "archive_timestamp",
    "n_high_priority_pages_discovered",
    "n_high_priority_pages_fetched",
    "n_high_priority_pages_missing",
    "n_secondary_pages_fetched",
    "n_broad_pages_fetched",
    "n_foreign_pages_deprioritized",
    "crawl_limit_reached",
    "unused_reserved_slots",
    "pages_fetched",
]
...
MANUAL_SCALING_VALIDATION_COLUMNS = [
    "firm_id",
    "relative_timepoint",
    "page_url",
    "duplicate_group_correct",
    "canonical_page_choice_correct",
